defmodule UM.Web.About do
  ...
  def handle_request(%{path: ["composers"]}, _) do
  ...
  def handle_request(%{path: ["search_and_purchase"]}, _) do
  ...
  def handle_request(%{path: ["licencing_and_copyright"]}, _) do
  ...
  def handle_request(%{path: ["refunds"]}, _) do
  ...
  def handle_request(%{path: ["privacy"]}, _) do
  ...
  def handle_request(%{path: ["terms_and_conditions"]}, _) do
  ...
  def handle_request(%{path: ["contact"]}, _) do
  ...
  def handle_request(%{path: ["sitemap"]}, _) do
